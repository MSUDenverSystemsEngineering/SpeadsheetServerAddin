...
Try {
	...
	[string]$appScriptDate = '12/6/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'iexplore,excel' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirSupportFiles\vcredist_x86_VS2015.exe" -Parameters '/q /norestart' -WindowStyle 'Hidden' -IgnoreExitCodes '1638'

		#Access Database Engine 2010
		Execute-MSI -Action Install -Path "$dirSupportFiles\ACEx86\AccessDatabaseEngine_2010.msi" -Parameters '/qn'

		#Access Database Engine 2016
		Execute-MSI -Action Install -Path "$dirSupportFiles\ACEx86\AccessDatabaseEngine_2016.msi" -Parameters '/qn'

		#Visual Studio 2010 Tools for Office Runtime
		Execute-Process -Path "$dirSupportFiles\vstor_redist.exe" -Parameters '/q:a /c: "install /q /l"' -WindowStyle 'Hidden'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7cs/Xqs7ChJlz9wrXfWjH349
# 2AuggguhMIIFrjCCBJagAwIBAgIQBwNx0Q95WkBxmSuUB2Kb4jANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTER3xUvHNQvW7A
# 2r4JCBXPbO4irTANBgkqhkiG9w0BAQEFAASCAQAbwwAHDCHmZ2L2r6vheJ3tD6/3
# fTLh5PFtdZAlABbbuFVFpj/7+9rDZxzJ61UoKd0Lqc7XPkmkayTaUzvz6203xH/p
# MZEHkacBqwezFEOgf2Fr/PIWcB+wep061BD0dVQ0TWHnHNq/J+sTEbjeKClBe0V1
# mNNyxpdzBfAH4TiN0+9n/J2Ue93hq1pyVJIwvHPKXxwg6Hs6g1EAlzBwi1hO1YY4
# x7UPyuF4QOub1IeAXmA3dlAN6utgMucyI9L1KjAMqsGrYuoZE18QrmAviQvrXTSt
# IZCwRjvHHzuSKCRCHM4VTyZh8llci+F9c2EuVvp+PaiYYE5f+YK/O7QKi9MF
